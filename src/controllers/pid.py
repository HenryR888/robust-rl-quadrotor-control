...
class CascadedPIDController:
    ...
    def __init__(self, params: Quadrotorparams):
        ...
        self.gains_x = PIDGains(kp=0.003,ki=0.0, kd=0.05, integral_limit=0.5) # TUNING COMPLETE
        self.gains_y = PIDGains(kp=0.003,ki=0.0, kd=0.05, integral_limit=0.5) # TUNING COMPLETE
